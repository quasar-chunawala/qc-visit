...
./bench_flat_array --benchmark_min_time=1.0s --benchmark_repetitions=30 --benchmark_out=flat_array_results.json --benchmark_out_format=json
...
./bench_stdlib_gcc --benchmark_min_time=1.0s --benchmark_repetitions=30 --benchmark_out=stdlib_results.json --benchmark_out_format=json